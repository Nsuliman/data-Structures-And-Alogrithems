...
const sortBackwards = (arr) => {
  // Solution code here...
//  return arr.sort((a, b) => b - a); // For descending sort};
...
const alphabetize = (arr) => {
  // Solution code here...
  // return arr.sort();        //  first way 

  return arr.sort ( (a,b) =>  a>b );        //  second way 
};
...
const sortByLength = (arr) => {
  // Solution code here...
  // return arr.sort((a,b) =>               //  first way
  //     a.length - b.length ); 

    return arr.sort((a,b)=> a.length>b.length);           //  second way 
};
...
const alphabetizeBetter = (arr) => {
  // // Solution code here...
  // return arr.sort((a, b) => (a.toLowerCase() < b.toLowerCase() ? -1 : 1));       //  first way

    return arr.sort((a,b) => a.toLowerCase()>b.toLowerCase() );           //  second way
};
...
const sortNumbersByLength = (arr) => {
  // Solution code here...
  // return arr.sort((a,b) => 
  // String(a).length - String(b).length );         //  first way

  return arr.sort((a,b)=> String(a).length > String(b).length);         //  second way
};
